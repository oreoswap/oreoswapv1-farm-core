...
contract MilkBar is BEP20("MilkBar Token", "MILK") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "oreo::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "oreo::delegateBySig: invalid nonce"
        );
        require(
            block.timestamp <= expiry,
            "oreo::delegateBySig: signature expired"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "oreo::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "oreo::_writeCheckpoint: block number exceeds 32 bits"
        );
